        ...
        const setDefaultValues = (product) => {
            ...
            categoriesRef?.current?.childNodes.forEach(li => {
                product.categories.forEach(cat => {
                    if (cat === li?.childNodes[0]?.innerText) {
                        li?.childNodes[0]?.classList.add('selected')
                    }
                })
            })
        }

    }, [dbCategories, params.productId]);
    return (
        <>
            <Box
                component="div"
            ...
            >
                ...
                >
                    <h4 className="page_title">Edit Product</h4>
                </Box>
                            ...
                            >
                                ...
                                <div className="form_group">
                                    <button
                                        ...
                                        {fetchingProduct ? <CircularProgress color="inherit" sx={{ width: '20px !important', height: '20px !important' }} /> : 'Update'}
                                    </button>
                                </div>
